...
CREATE TABLE `positions` (
  ...
  `LongVolume` int(10) unsigned NOT NULL DEFAULT '0',
  `LongPrice` double NOT NULL DEFAULT '0',
  `ShortVolume` int(10) unsigned NOT NULL DEFAULT '0',
  `ShortPrice` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
